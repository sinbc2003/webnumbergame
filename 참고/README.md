...
Python과 그래픽 라이브러리인 Tkinter를 사용하여 만든 교육용 수학 게임입니다. 학생들이 주어진 목표 숫자를 만들기 위해 `1`, `+`, `*`, `(`, `)` 기호만으로 수학 표현식을 구성하는 게임입니다. 1라운드 개인전과 2라운드 팀전 모드를 지원하며, 코스트(비용) 개념을 도입하여 전략적 사고를 유도합니다.
