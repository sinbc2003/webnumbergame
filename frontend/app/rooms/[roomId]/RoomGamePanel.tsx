    ...
    return (
      <div className={lobbyShellClass}>
        ...
        <div className="mt-3 flex flex-1 flex-col gap-3 overflow-hidden sm:mt-4">
          ...
          <div className="flex w-full flex-1 flex-col rounded-2xl border border-night-800/70 bg-night-900/40 p-3 text-night-200 max-h-[520px] overflow-hidden lg:max-h-[60vh] sm:p-4">
